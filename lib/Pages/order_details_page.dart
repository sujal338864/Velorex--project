...
class _OrderDetailsPageState extends State<OrderDetailsPage> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSummaryRow(
                            "Total Amount Paid",
                            "₹${safeDouble(order['totalAmount']).toStringAsFixed(2)}",
                          ),
  ...
  List<Widget> _buildItemCards(List<dynamic> items) {
    return items.map((item) {
      ...
      final finalAmount = safeDouble(item['finalAmount']);
      final delivery = safeDouble(item['deliveryCharge']);
      final couponShare = safeDouble(item['couponShare']);

      final product = OnesolutionModel()
          .getById(int.tryParse(item["productId"].toString()) ?? 0);
